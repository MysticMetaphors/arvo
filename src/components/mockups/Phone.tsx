export default function Phone({ children }: Readonly<{
  ...
  return (
    <div className="relative w-[300px] mx-auto">
      <div className="relative bg-gray-900 dark:bg-gray-950 p-2 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.4)] border border-gray-800 dark:border-gray-700 transition-colors duration-300">
