export default function Partners() {
  return (
    <section id="partners" className="bg-black-primary">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:pt-12 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-16">
          ...
          <p className="mb-5 text-gray-400 sm:text-md">Real stories from people who trusted us to bring their ideas to life. Their success is what keeps us going.</p>
        </div>
      </div>
      {/* <div className="mb-20">
