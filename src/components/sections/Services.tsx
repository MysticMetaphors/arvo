        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-20 lg:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-6 gap-10">
            ...
            <motion.div
              ...
              <a
                href="#"
                className="text-white bg-green-500/70 hover:bg-green-600 transition-all duration-200 focus:ring-4 focus:ring-green-400 font-semibold rounded-lg text-sm px-6 py-3 text-center shadow-md"
              >
                Get started
              </a>
            </motion.div>
