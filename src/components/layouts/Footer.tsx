        ...
        <footer className="bg-black-primary border-t-3 border-green-primary">
            <div className="mx-auto w-full  max-w-screen-xl p-4 py-6 lg:py-20">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-200">
                                ...
                                <li>
                                    <Link href="/pricing" className="hover:underline font-normal" >Custome</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-200">
                                ...
                                {/* <li>
                                    <Link href="https://www.linkedin.com/in/jerrytagle" className="hover:underline font-normal" >LinkedIn</Link>
                                </li> */}
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-400 sm:text-center">© 2025 <Link href="#" className="hover:underline font-normal" >Arvo™</Link>. All Rights Reserved.
                    </span>
                    <div></div>
                    {/* <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <Link href="#" className="text-gray-400 hover:text-green-primary">
                            <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                            </svg>
                            <span className="sr-only">Facebook page</span>
                        </Link>
                        <Link href="#" className="text-gray-400 hover:text-green-primary ms-5">
